...
<!--simditor-->
<link rel="stylesheet" type="text/css" href="/DearHouAimin/lib/simditor/styles/simditor.css" />
...
<!--simditor-->
<script type="text/javascript" src="/DearHouAimin/lib/simditor/scripts/jquery.min.js"></script>
<script type="text/javascript" src="/DearHouAimin/lib/simditor/scripts/module.js"></script>
<script type="text/javascript" src="/DearHouAimin/lib/simditor/scripts/hotkeys.js"></script>
<script type="text/javascript" src="/DearHouAimin/lib/simditor/scripts/uploader.js"></script>
<script type="text/javascript" src="/DearHouAimin/lib/simditor/scripts/simditor.js"></script>
