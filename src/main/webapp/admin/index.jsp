...
<!--[if lt IE 9]>
<script type="text/javascript" src="/DearHouAimin/lib/html5shiv.js"></script>
<script type="text/javascript" src="/DearHouAimin/lib/respond.min.js"></script>
<![endif]-->
...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-picture">
			...
			<dd>
				<ul>
					<li><a data-href="_blank.html" data-title="课程简介" href="javascript:void(0)">课程简介</a></li>
					<li><a data-href="_blank.html" data-title="课程特色" href="javascript:void(0)">课程特色</a></li>
					<li><a data-href="/DearHouAimin/textServlet?method=getAll" data-title="教材与参考资料" href="javascript:void(0)">教材与参考资料</a></li>
					<li><a data-href="/DearHouAimin/admin/courseDetail/courseDetail-4.jsp" data-title="历史沿革" href="javascript:void(0)">历史沿革</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-product">
		...
		<dl id="menu-product">
				...
				<dd>
					<ul>
						<li><a data-href="/ResourceServlet.do?type=findAll&resType=1" data-title="教程课件" href="javascript:void(0)">教程课件</a></li>
						<li><a data-href="/ResourceServlet.do?type=findAll&resType=2" data-title="教学录像" href="javascript:void(0)">教学录像</a></li>
						<li><a data-href="/ResourceServlet.do?type=findAll&resType=3" data-title="习题库" href="javascript:void(0)">习题库</a></li>
						<li><a data-href="/ResourceServlet.do?type=findAll&resType=4" data-title="案例库" href="javascript:void(0)">案例库</a></li>
						<li><a data-href="/ResourceServlet.do?type=findAll&resType=5" data-title="实验任务" href="javascript:void(0)">实验任务</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-product">
			<dt><i class="Hui-iconfont">&#xe620;</i> 教学效果<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
				<dd>
					<ul>
						...
						<li><a data-href="_blank.html" data-title="产品管理" href="javascript:void(0)">校内学生评价</a></li>
...
<script type="text/javascript" src="/DearHouAimin/static/h-ui.admin/js/H-ui.admin.js"></script> <!--/_footer 作为公共模版分离出去-->

<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="/DearHouAimin/lib/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
