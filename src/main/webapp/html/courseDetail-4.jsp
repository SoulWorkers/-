...
try {
	...
	this.connection=DriverManager.getConnection("jdbc:mysql://localhost:3307/uml_open_course_db?useSSL=false&useUnicode=true&characterEncoding=UTF-8","root","dgutdev#uml");
